...
<script src="ui/js/single_payment.js"></script>
...
<div class="row">
    <div class="col-md-3">
        ...
        <form action="<?php echo $payPal->payNowButtonUrl; ?>" method="post">
            ...
            <input type="hidden" name="return" value="<?php echo $config['app_url']; ?>/single_payment/?status=success">

            <input id="paypalCustomData" type="hidden" name="custom" value="">
